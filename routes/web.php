...
Route::post('/products', [ProductController::class, 'create_product'])->name('product.create');
Route::patch('/products/{id}', [ProductController::class, 'update_product'])->name('product.update');
